...
TIDV and TADV, when properly set, can be used to provide TX interrupt mitigation on a per-descriptor basis.
...
RDTR and RADV, when properly set, can be used to provide RX interrupt mitigation on a per-received-frame basis.
