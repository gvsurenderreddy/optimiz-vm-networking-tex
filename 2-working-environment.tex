...
The following figures depict some examples about the RDTR and RADV moderation mechanism.
...
With reference to the QEMU thread model, register callbacks are executed by a VCPU thread.
