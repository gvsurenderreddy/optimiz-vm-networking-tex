...
\textbf{TX bitrate} & 15.0 & Mbps\\
\textbf{TX notifications rate} & 20.6 & KHz\\
\textbf{MMIO write rate} & 61.7 & KHz\\
\textbf{MMIO read rate} & 61.7 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 23.6 & KHz\\
\textbf{TX packet rate} & 30.4 & Kpps\\
\textbf{TX bitrate} & 22.1 & Mbps\\
\textbf{TX notifications rate} & 30.4 & KHz\\
\textbf{MMIO write rate} & 61.9 & KHz\\
\textbf{MMIO read rate} & 47.3 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{RX bitrate} & 10.5 & Mbps\\
\textbf{RX notifications} & 14.3 & Mbps\\
\textbf{MMIO write rate} & 42.9 & KHz\\
\textbf{MMIO read rate} & 42.9 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 6.7 & KHz\\
\textbf{RX packet rate} & 185.7 & Kpps\\
\textbf{RX bitrate} & 135.1 & Mbps\\
\textbf{RX notifications} & 13.7 & Mbps\\
\textbf{MMIO write rate} & 22.7 & KHz\\
\textbf{MMIO read rate} & 13.5 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{TX packet rate} & 47.8 & Kpps\\
\textbf{TX bitrate} & 34.8 & Mbps\\
\textbf{TX notifications rate} & 47.8 & KHz\\
\textbf{MMIO write rate} & 55.5 & KHz\\
\textbf{MMIO read rate} & 11.5 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
\textbf{Interrupt rate} & 3.8 & KHz\\
\textbf{TX packet rate} & 47.2 & Kpps\\
\textbf{TX bitrate} & 34.3 & Mbps\\
\textbf{TX notifications rate} & 47.2 & KHz\\
\textbf{MMIO write rate} & 54.8 & KHz\\
\textbf{MMIO read rate} & 11.5 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\toprule
\textbf{Interrupt rate} & 3.8 & KHz\\
\textbf{RX packet rate} & 137.1 & Kpps\\
\textbf{RX bitrate} & 99.8 & Mbps\\
\textbf{RX notifications} & 10.3 & Mbps\\
\textbf{MMIO write rate} & 18.0 & KHz\\
\textbf{MMIO read rate} & 11.5 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 2.1 & KHz\\
\textbf{RX packet rate} & 216.7 & Kpps\\
\textbf{RX bitrate} & 157.7 & Mbps\\
\textbf{RX notifications} & 14.3 & Mbps\\
\textbf{MMIO write rate} & 18.5 & KHz\\
\textbf{MMIO read rate} & 6.3 & KHz\\
\bottomrule
\end{tabular}
\end{center}
\caption{Host to guest statistics with 1 VCPU per guest, when interrupt moderation is implemented.}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 1.8 & KHz\\
\textbf{TX packet rate} & 163.5 & Kpps\\
\textbf{TX bitrate} & 119.0 & Mbps\\
\textbf{TX notifications rate} & 1.8 & KHz\\
\textbf{MMIO write rate} & 5.5 & KHz\\
\textbf{MMIO read rate} & 5.6 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 2.8 & KHz\\
\textbf{TX packet rate} & 145.0 & Kpps\\
\textbf{TX bitrate} & 105.6 & Mbps\\
\textbf{TX notifications rate} & 2.8 & KHz\\
\textbf{MMIO write rate} & 8.3 & KHz\\
\textbf{MMIO read rate} & 8.4 & KHz\\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lrl}
\toprule
\textbf{Interrupt rate} & 7.8 & KHz\\
\textbf{TX packet rate} & 95.4 & Kpps\\
\textbf{TX bitrate} & 69.5 & Mbps\\
\textbf{TX notifications rate} & 7.8 & KHz\\
\textbf{MMIO write rate} & 23.5 & KHz\\
\textbf{MMIO read rate} & 23.5 & KHz\\
\bottomrule
\end{tabular}
\end{center}
