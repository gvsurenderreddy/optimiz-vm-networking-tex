...
and functionality of one system on a system having a different interface and functionality. %\cite{Smith},
...
are trying to access resources that does not exists on the physical machines, or because they are not easily virtualizable. %cite{x86}
