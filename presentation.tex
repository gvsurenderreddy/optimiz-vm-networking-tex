...
\frametitle{The problem}
  \begin{block}{VM network performance is low with hardware virtualization}
    \begin{itemize}
      \pause
      \item CPU switches between the host world and the guest world
      \pause
...
\begin{frame}
    \begin{block}{KVM mechanics}
      \begin{itemize}
	\item VCPUs switches between guest world and host world
	\pause
...
\begin{frame}
\frametitle{Linux interface with the network driver}
  \begin{columns}
  \begin{column}{0.5\textwidth}
    \begin{figure}
...
\begin{frame}
    \begin{figure}
      \includegraphics[width=.50\columnwidth]{virtio.pdf}
    \end{figure}
\end{frame}
