...
Network performance is a critical aspect in Virtual Machine systems which is becoming increasingly important in the world of computing.
...
In this thesis we are going to analyze the state of the art of virtual machine networking, evaluating advantages
...
network device (we take \texttt{e1000} as a reference example) to a performance that is comparable or superior to the performance of 
...
\input{4-e1000-paravirtualization}
\input{5-conclusion}
